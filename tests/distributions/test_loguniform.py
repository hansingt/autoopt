...
class LogUniformTestCase(unittest.TestCase):
    ...
    def test_max(self):
        ...
        dist = LogUniform(min_value=1, max_value=max_value)
    ...
    def test_pdf(self):
        ...
        dist = LogUniform(min_value=min_value, max_value=max_value)
    ...
    def test_zero_boundary(self):
        self.assertRaises(ValueError, LogUniform, min_value=0, max_value=1)
